...
public class LockHandler {
     ...
     */
    public static void runWithLockAndTimeout(OriginVertxContext context, String lockKey, long expireTime, Runnable fn) {
        ...
        AsyncResultHandler.handleFuture(future, lock -> {
            fn.run();
            lock.release();
        });
    }
     ...
     */
    public static void runWithLock(OriginVertxContext context, String lockKey, Runnable fn) {
     ...
     */
    public static void runWithLock(OriginVertxContext context, Consumer<Lock> fn) {
        ...
        AsyncResultHandler.handleFuture(future, fn);
    }
